...
exports.gatherValidationErrors = exports.calculateIsValid = exports.createGetFieldValid = exports.createGetError = exports.createGetAllErrors = exports.createValidateAllIfTrue = exports.createValidateAll = exports.createValidateIfTrue = exports.createValidate = exports.updatePropertyOnState = exports.createValidationState = exports.isPropertyValid = exports.stringIsNotEmpty = exports.stringIsMoreThan = exports.stringIsLessThan = exports.prop = exports.compose = void 0;
...
function createValidate(validationSchema, validationState, setValidationState) {
    return (property, value) => maybe_1.maybe(value)
        .map(updatePropertyOnState(validationSchema)(property))
        .map(R.mergeRight(utilities_1.readValue(validationState)))
...
function createValidateIfTrue(validationSchema, validationState, setValidationState) {
...
function createValidateAllIfTrue(validationSchema, validationState, setValidationState) {
    return (value, props = Object.keys(validationSchema)) => {
        const reduceValids = (acc, property) => {
            const updated = updatePropertyOnState(validationSchema)(property, value);
            return updated[property].isValid
                ? { ...acc, ...updated }
                : { ...acc, ...utilities_1.readValue(validationState)[property] };
        };
        return maybe_1.maybe(props)
...
function createGetError(validationState) {
    return (property, vState = utilities_1.readValue(validationState)) => {
...
function createGetFieldValid(validationState) {
    return (property) => exports.isPropertyValid(property)(utilities_1.readValue(validationState));
}
exports.createGetFieldValid = createGetFieldValid;
function calculateIsValid(validationState) {
    return Object.keys(utilities_1.readValue(validationState)).reduce((acc, curr) => {
        return acc ? exports.isPropertyValid(curr)(utilities_1.readValue(validationState)) : acc;
    }, true);
}
exports.calculateIsValid = calculateIsValid;
;
function gatherValidationErrors(state) {
    return Object.keys(utilities_1.readValue(state)).reduce((acc, curr) => {
        return createGetError(utilities_1.readValue(state))(curr)
            ? [...acc, createGetError(utilities_1.readValue(state))(curr)]
            : acc;
    }, []);
}
exports.gatherValidationErrors = gatherValidationErrors;
